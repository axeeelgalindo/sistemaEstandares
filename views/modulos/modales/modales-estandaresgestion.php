  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="editarEstandar" enctype="multipart/form-data">
        ...
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
          <button type="button" class="btn btn-success" id="btnValidar"><i class="far fa-solid fa-check"></i>
            Validar</button>
        </div>
      </form>
    </div>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="editarEstandar" enctype="multipart/form-data">
        ...
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
          <button type="button" class="btn btn-danger" id="btnRevertir"><i class="fas fa-user-times"></i> Revertir
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <form id="editarEstandar" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            <?php
                            $planta_id = $_SESSION['planta_id'];
                            $tabla6 = ModeloArea::listarAreaMdl(@$planta_id);
        ...
        <div class="modal-footer justify-content-between">
          <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
          <button type="button" class="btn btn-success" data-dismiss="modal" id="applyFilter"><i
              class="far fa-solid fa-check"></i> Filtrar</button>
        </div>
      </form>
    </div>
    <!-- /.modal-content -->
