        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="email" id="email" placeholder="Ingrese email"  required>  
            </div>
            <div class="form-group">
            <label for="exampleInputEmail1">Contraseña:</label>
            <div class="password-container">
            <input type="password" class="form-control" name="password" id="password1" placeholder="Ingrese password"  required>  
            ...
            <div class="password-container">
            <input type="password" class="form-control" name="password2" id="password2" placeholder="Ingrese password"  required>  
      ...
      <div class="modal fade" id="modal-editar-usuario" style="overflow-y: scroll;">
        <div class="modal-dialog modal-l">
          ...
          <form id="editarUsuario" enctype="multipart/form-data">
            ...
            <label for="exampleInputEmail1">Contraseña:</label>
            <div class="password-container">
            <input type="password" class="form-control" name="password" id="password3" placeholder="Ingrese password"  required>  
