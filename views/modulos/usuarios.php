...
<div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <button class="col-md-2 col-sm-12 btn btn-sm btn-secondary" data-toggle="modal" data-target="#modal-insertar-nuevo-usuario">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
          $tabla = ModeloUsuario::listarUsuarioMdl();
